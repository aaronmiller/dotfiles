...
(def-doom-theme spacegrey-wilmersdorf
  ...
  ;; spacegrey
  ;; name        default   256       16
  ((bg         '("#3c414c" "#3c414c" nil            ))
   (bg-alt     '("#343941" "#343941" nil            ))
   (base0      '("#2c333a" "#2c333a" "black"        ))
   (base1      '("#2d3035" "#2d3035" "brightblack"  ))
   (base2      '("#313439" "#313439" "brightblack"  ))
   (base3      '("#404348" "#404348" "brightblack"  ))
   (base4      '("#606c77" "#606c77" "brightblack"  ))
   (base5      '("#76848f" "#76848f" "brightblack"  ))
   (base6      '("#848a8f" "#848a8f" "brightblack"  ))
   (base7      '("#adb1b5" "#adb1b5" "brightblack"  ))
   (base8      '("#f0f0f0" "#f0f0f0" "white"        ))
   (fg         '("#d1d6df" "#d1d6df" "brightwhite"  ))
   (fg-alt     '("#d1d6df" "#d1d6df" "white"        ))

   ;; wilmersdorf
   (grey       base4)
   (red        '("#f2d2ff" "#f2d2ff" "red"          ))
   (orange     '("#b7d2f1" "#b7d2f1" "brightred"    ))
   (green      '("#6ca5bc" "#6ca5bc" "green"        ))
   (teal       '("#8fcfce" "#8fcfce" "brightgreen"  ))
   (yellow     '("#e0e0ad" "#e0e0ad" "yellow"       ))
   (blue       '("#92ade7" "#92ade7" "brightblue"   ))
   (light-blue '("#a1b7ec" "#a1b7ec" "yellow"       ))
   (dark-blue  '("#727da7" "#727da7" "blue"         ))
   (magenta    '("#b7d2f1" "#b7d2f1" "magenta"      ))
   (violet     '("#c1b3f8" "#c1b3f8" "brightmagenta"))
   (cyan       '("#839acd" "#839acd" "brightcyan"   ))
   (dark-cyan  '("#7f89aa" "#7f89aa" "cyan"   ))
