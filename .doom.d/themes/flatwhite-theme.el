...
(def-doom-theme flatwhite
  "A minimal light syntax theme"

  ;; name        default   256       16
  (
   (fw-base1           '("#605a52" "#605a52" "black"))
   (fw-base2           '("#93836c" "#93836c" "brightblack"))
   (fw-base3           '("#b9a992" "#b9a992" "brightblack"))
   (fw-base4           '("#dcd3c6" "#dcd3c6" "brightblack"))
   (fw-base5           '("#e4ddd2" "#e4ddd2" "brightblack"))
   (fw-base6           '("#f1ece4" "#f1ece4" "brightblack"))
   (fw-base7           '("#f7f3ee" "#f7f3ee" "brightblack"))

   (fw-accent          '("#6a4dff" "#6a4dff" "brightblue"))

   (fw-orange-text     '("#5b5143" "#5b5143" "brightblack"))
   (fw-orange-text-sec '("#957f5f" "#957f5f" "brightblack"))
   (fw-orange          '("#f08c00" "#f08c00" "orange"))
   (fw-orange-blend    '("#f7e0c3" "#f7e0c3" "brightorange"))

   (fw-red-text        '("#5b4343" "#5b4343" "brightblack"))
   (fw-red-text-sec    '("#955f5f" "#955f5f" "brightblack"))
   (fw-red             '("#f00000" "#f00000" "red"))
   (fw-red-blend       '("#f6cfcb" "#f6cfcb" "brightred"))

   (fw-green-text      '("#525643" "#525643" "brightblack"))
   (fw-green-text-sec  '("#81895d" "#81895d" "brightblack"))
   (fw-green           '("#84bd00" "#84bd00" "green"))
   (fw-green-blend     '("#e2e9c1" "#e2e9c1" "brightgreen"))

   (fw-teal-text       '("#465953" "#465953" "brightblack"))
   (fw-teal-text-sec   '("#5f8c7d" "#5f8c7d" "brightblack"))
   (fw-teal            '("#00bda4" "#00bda4" "cyan"))
   (fw-teal-blend      '("#d2ebe3" "#d2ebe3" "brightcyan"))

   (fw-blue-text       '("#4c5361" "#4c5361" "brightblack"))
   (fw-blue-text-sec   '("#7382a0" "#7382a0" "brightblack"))
   (fw-blue            '("#75a3ff" "#75a3ff" "blue"))
   (fw-blue-blend      '("#dde4f2" "#dde4f2" "brightblue"))

   (fw-purple-text     '("#614c61" "#614c61" "brightblack"))
   (fw-purple-text-sec '("#9c739c" "#9c739c" "brightblack"))
   (fw-purple          '("#ce5cff" "#ce5cff" "purple"))
   (fw-purple-blend    '("#f1ddf1" "#f1ddf1" "brightpurple"))
