...
(def-doom-theme moonlight-wilmersdorf
  ...
  ;; moonlight
  ;; name        default   256       16
  ((bg         '("#0b2641" "#0b2641" "black"))
   (bg-alt     '("#031d34" "#031d34" "black"))
   (base0      '("#001d34" "#001d34" "black"))
   (base1      '("#031d34" "#031d34" "brightblack"))
   (base2      '("#08233a" "#08233a" "brightblack"))
   (base3      '("#0c2740" "#0c2740" "brightblack"))
   (base4      '("#193657" "#193657" "brightblack"))
   (base5      '("#2e4d7d" "#2e4d7d" "brightblack"))
   (base6      '("#6c8ec2" "#6c8ec2" "brightblack"))
   (base7      '("#93bbf2" "#93bbf2" "brightblack"))
   (base8      '("#9ec5fa" "#9ec5fa" "white"))
   (indigo     '("#648bd9" "#648bd9" "brightblack"))
   (region     '("#224166" "#224166" "brightblack"))
   (fg         '("#b2d6ff" "#b2d6ff" "brightwhite"))
   (fg-alt     '("#9ec5fa" "#9ec5fa" "white"))

   ;; wilmersdorf
   (grey       base4)
   (red        '("#cbc4f8" "#cbc4f8" "red"          ))
   (orange     '("#90c4ea" "#90c4ea" "brightred"    ))
   (green      '("#4597b5" "#4597b5" "green"        ))
   (teal       '("#68c1c7" "#68c1c7" "brightgreen"  ))
   (yellow     '("#b9d2a6" "#b9d2a6" "yellow"       ))
   (blue       '("#6b9fe0" "#6b9fe0" "brightblue"   ))
   (light-blue '("#7aa9e5" "#7aa9e5" "yellow"       ))
   (dark-blue  '("#4b6fa0" "#4b6fa0" "blue"         ))
   (magenta    '("#90c4ea" "#90c4ea" "magenta"      ))
   (violet     '("#9aa5f1" "#9aa5f1" "brightmagenta"))
   (cyan       '("#5c8cc6" "#5c8cc6" "brightcyan"   ))
   (dark-cyan  '("#587ba3" "#587ba3" "cyan"   ))
