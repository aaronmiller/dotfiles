...
(def-doom-theme moonlight-wilmersdorf
  ...
  ;; moonlight
  ;; name        default   256       16
  ((bg         '("#0b3641" "#0b3641" "black"))
   (bg-alt     '("#032d34" "#032d34" "black"))
   (base0      '("#002d34" "#002d34" "black"))
   (base1      '("#032d34" "#032d34" "brightblack"))
   (base2      '("#08333a" "#08333a" "brightblack"))
   (base3      '("#0c3740" "#0c3740" "brightblack"))
   (base4      '("#194657" "#194657" "brightblack"))
   (base5      '("#2e5d7d" "#2e5d7d" "brightblack"))
   (base6      '("#6c9ec2" "#6c9ec2" "brightblack"))
   (base7      '("#93cbf2" "#93cbf2" "brightblack"))
   (base8      '("#9ed5fa" "#9ed5fa" "white"))
   (indigo     '("#649bd9" "#649bd9" "brightblack"))
   (region     '("#225166" "#225166" "brightblack"))
   (fg         '("#b2e6ff" "#b2e6ff" "brightwhite"))
   (fg-alt     '("#9ed5fa" "#9ed5fa" "white"))

   ;; wilmersdorf
   (grey       base5)
   (red        '("#cbd4f8" "#cbd4f8" "red"          ))
   (orange     '("#90d4ea" "#90d4ea" "brightred"    ))
   (green      '("#45a7b5" "#45a7b5" "green"        ))
   (teal       '("#68d1c7" "#68d1c7" "brightgreen"  ))
   (yellow     '("#b9e2a6" "#b9e2a6" "yellow"       ))
   (blue       '("#6bafe0" "#6bafe0" "brightblue"   ))
   (light-blue '("#7ab9e5" "#7ab9e5" "yellow"       ))
   (dark-blue  '("#4b7fa0" "#4b7fa0" "blue"         ))
   (magenta    '("#90d4ea" "#90d4ea" "magenta"      ))
   (violet     '("#9ab5f1" "#9ab5f1" "brightmagenta"))
   (cyan       '("#5c9cc6" "#5c9cc6" "brightcyan"   ))
   (dark-cyan  '("#588ba3" "#588ba3" "cyan"   ))
