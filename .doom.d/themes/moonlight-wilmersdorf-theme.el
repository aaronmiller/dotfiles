...
(def-doom-theme moonlight-wilmersdorf
  ...
  ;; moonlight
  ;; name        default   256       16
  ((bg         '("#0b3d41" "#0b3d41" "black"))
   (bg-alt     '("#033434" "#033434" "black"))
   (base0      '("#003434" "#003434" "black"))
   (base1      '("#033434" "#033434" "brightblack"))
   (base2      '("#083a3a" "#083a3a" "brightblack"))
   (base3      '("#0c3e40" "#0c3e40" "brightblack"))
   (base4      '("#194d57" "#194d57" "brightblack"))
   (base5      '("#2e647d" "#2e647d" "brightblack"))
   (base6      '("#6ca5c2" "#6ca5c2" "brightblack"))
   (base7      '("#93d2f2" "#93d2f2" "brightblack"))
   (base8      '("#9edcfa" "#9edcfa" "white"))
   (indigo     '("#64a2d9" "#64a2d9" "brightblack"))
   (region     '("#225866" "#225866" "brightblack"))
   (fg         '("#b2edff" "#b2edff" "brightwhite"))
   (fg-alt     '("#9edcfa" "#9edcfa" "white"))

   ;; wilmersdorf
   (grey       base5)
   (red        '("#cbdbf8" "#cbdbf8" "red"          ))
   (orange     '("#90dbea" "#90dbea" "brightred"    ))
   (green      '("#45aeb5" "#45aeb5" "green"        ))
   (teal       '("#68d8c7" "#68d8c7" "brightgreen"  ))
   (yellow     '("#b9e9a6" "#b9e9a6" "yellow"       ))
   (blue       '("#6bb6e0" "#6bb6e0" "brightblue"   ))
   (light-blue '("#7ac0e5" "#7ac0e5" "yellow"       ))
   (dark-blue  '("#4b86a0" "#4b86a0" "blue"         ))
   (magenta    '("#90dbea" "#90dbea" "magenta"      ))
   (violet     '("#9abcf1" "#9abcf1" "brightmagenta"))
   (cyan       '("#5ca3c6" "#5ca3c6" "brightcyan"   ))
   (dark-cyan  '("#5892a3" "#5892a3" "cyan"   ))
