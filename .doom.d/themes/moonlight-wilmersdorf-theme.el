...
(def-doom-theme moonlight-wilmersdorf
  ...
  ;; moonlight
  ;; name        default   256       16
  ((bg         '("#214f41" "#214f41" "black"))
   (bg-alt     '("#194634" "#194634" "black"))
   (base0      '("#164634" "#164634" "black"))
   (base1      '("#194634" "#194634" "brightblack"))
   (base2      '("#1e4c3a" "#1e4c3a" "brightblack"))
   (base3      '("#225040" "#225040" "brightblack"))
   (base4      '("#2f5f57" "#2f5f57" "brightblack"))
   (base5      '("#44767d" "#44767d" "brightblack"))
   (base6      '("#82b7c2" "#82b7c2" "brightblack"))
   (base7      '("#a9e4f2" "#a9e4f2" "brightblack"))
   (base8      '("#b4eefa" "#b4eefa" "white"))
   (indigo     '("#7ab4d9" "#7ab4d9" "brightblack"))
   (region     '("#386a66" "#386a66" "brightblack"))
   (fg         '("#c8ffff" "#c8ffff" "brightwhite"))
   (fg-alt     '("#b4eefa" "#b4eefa" "white"))

   ;; wilmersdorf
   (grey       base5)
   (red        '("#e1edf8" "#e1edf8" "red"          ))
   (orange     '("#a6edea" "#a6edea" "brightred"    ))
   (green      '("#5bc0b5" "#5bc0b5" "green"        ))
   (teal       '("#7eeac7" "#7eeac7" "brightgreen"  ))
   (yellow     '("#cffba6" "#cffba6" "yellow"       ))
   (blue       '("#81c8e0" "#81c8e0" "brightblue"   ))
   (light-blue '("#90d2e5" "#90d2e5" "yellow"       ))
   (dark-blue  '("#6198a0" "#6198a0" "blue"         ))
   (magenta    '("#a6edea" "#a6edea" "magenta"      ))
   (violet     '("#b0cef1" "#b0cef1" "brightmagenta"))
   (cyan       '("#72b5c6" "#72b5c6" "brightcyan"   ))
   (dark-cyan  '("#6ea4a3" "#6ea4a3" "cyan"   ))
