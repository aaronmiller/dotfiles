...
(def-doom-theme moonlight-wilmersdorf
  ...
  ;; default bg #212337
  ;; name        default   256       16
  ((bg         '("#0b4f41" "#0b4f41" "black"))
   (bg-alt     '("#034634" "#034634" "black"))
   (base0      '("#004634" "#004634" "black"))
   (base1      '("#034634" "#034634" "brightblack"))
   (base2      '("#084c3a" "#084c3a" "brightblack"))
   (base3      '("#0c5040" "#0c5040" "brightblack"))
   (base4      '("#195f57" "#195f57" "brightblack"))
   (base5      '("#2e767d" "#2e767d" "brightblack"))
   (base6      '("#6cb7c2" "#6cb7c2" "brightblack"))
   (base7      '("#93e4f2" "#93e4f2" "brightblack"))
   (base8      '("#9eeefa" "#9eeefa" "white"))
   (indigo     '("#64b4d9" "#64b4d9" "brightblack"))
   (region     '("#226a66" "#226a66" "brightblack"))
   (fg         '("#b2ffff" "#b2ffff" "brightwhite"))
   (fg-alt     '("#9eeefa" "#9eeefa" "white"))

   (grey       base5)
   (red        '("#cbedf8" "#cbedf8" "red"          ))
   (orange     '("#90edea" "#90edea" "brightred"    ))
   (green      '("#45c0b5" "#45c0b5" "green"        ))
   (teal       '("#68eac7" "#68eac7" "brightgreen"  ))
   (yellow     '("#b9fba6" "#b9fba6" "yellow"       ))
   (blue       '("#6bc8e0" "#6bc8e0" "brightblue"   ))
   (light-blue '("#7ad2e5" "#7ad2e5" "yellow"       ))
   (dark-blue  '("#4b98a0" "#4b98a0" "blue"         ))
   (magenta    '("#90edea" "#90edea" "magenta"      ))
   (violet     '("#9acef1" "#9acef1" "brightmagenta"))
   (cyan       '("#5cb5c6" "#5cb5c6" "brightcyan"   ))
   (dark-cyan  '("#58a4a3" "#58a4a3" "cyan"   ))
