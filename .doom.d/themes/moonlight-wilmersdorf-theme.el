...
(def-doom-theme moonlight-wilmersdorf
  ...
  ;; moonlight
  ;; name        default   256       16
  ((bg         '("#0b4f3d" "#0b4f3d" "black"))
   (bg-alt     '("#034630" "#034630" "black"))
   (base0      '("#004630" "#004630" "black"))
   (base1      '("#034630" "#034630" "brightblack"))
   (base2      '("#084c36" "#084c36" "brightblack"))
   (base3      '("#0c503c" "#0c503c" "brightblack"))
   (base4      '("#195f53" "#195f53" "brightblack"))
   (base5      '("#2e7679" "#2e7679" "brightblack"))
   (base6      '("#6cb7be" "#6cb7be" "brightblack"))
   (base7      '("#93e4ee" "#93e4ee" "brightblack"))
   (base8      '("#9eeef6" "#9eeef6" "white"))
   (indigo     '("#64b4d5" "#64b4d5" "brightblack"))
   (region     '("#226a62" "#226a62" "brightblack"))
   (fg         '("#b2fffb" "#b2fffb" "brightwhite"))
   (fg-alt     '("#9eeef6" "#9eeef6" "white"))

   ;; wilmersdorf
   (grey       base5)
   (red        '("#cbedf4" "#cbedf4" "red"          ))
   (orange     '("#90ede6" "#90ede6" "brightred"    ))
   (green      '("#45c0b1" "#45c0b1" "green"        ))
   (teal       '("#68eac3" "#68eac3" "brightgreen"  ))
   (yellow     '("#b9fba2" "#b9fba2" "yellow"       ))
   (blue       '("#6bc8dc" "#6bc8dc" "brightblue"   ))
   (light-blue '("#7ad2e1" "#7ad2e1" "yellow"       ))
   (dark-blue  '("#4b989c" "#4b989c" "blue"         ))
   (magenta    '("#90ede6" "#90ede6" "magenta"      ))
   (violet     '("#9aceed" "#9aceed" "brightmagenta"))
   (cyan       '("#5cb5c2" "#5cb5c2" "brightcyan"   ))
   (dark-cyan  '("#58a49f" "#58a49f" "cyan"   ))
