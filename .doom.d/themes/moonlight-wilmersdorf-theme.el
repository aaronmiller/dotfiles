...
(def-doom-theme moonlight-wilmersdorf
  ...
  ;; name        default   256       16
  ((bg         '("#1b3d41" "#1b3d41" "black"))
   (bg-alt     '("#133434" "#133434" "black"))
   (base0      '("#103434" "#103434" "black"))
   (base1      '("#133434" "#133434" "brightblack"))
   (base2      '("#183a3a" "#183a3a" "brightblack"))
   (base3      '("#1c3e40" "#1c3e40" "brightblack"))
   (base4      '("#294d57" "#294d57" "brightblack"))
   (base5      '("#3e647d" "#3e647d" "brightblack"))
   (base6      '("#7ca5c2" "#7ca5c2" "brightblack"))
   (base7      '("#a3d2f2" "#a3d2f2" "brightblack"))
   (base8      '("#aedcfa" "#aedcfa" "white"))
   (indigo     '("#74a2d9" "#74a2d9" "brightblack"))
   (region     '("#325866" "#325866" "brightblack"))
   (fg         '("#c2edff" "#c2edff" "brightwhite"))
   (fg-alt     '("#aedcfa" "#aedcfa" "white"))

   (grey       base5)
   (red        '("#dbdbf8" "#dbdbf8" "red"          ))
   (orange     '("#a0dbea" "#a0dbea" "brightred"    ))
   (green      '("#55aeb5" "#55aeb5" "green"        ))
   (teal       '("#78d8c7" "#78d8c7" "brightgreen"  ))
   (yellow     '("#c9e9a6" "#c9e9a6" "yellow"       ))
   (blue       '("#7bb6e0" "#7bb6e0" "brightblue"   ))
   (light-blue '("#8ac0e5" "#8ac0e5" "yellow"       ))
   (dark-blue  '("#5b86a0" "#5b86a0" "blue"         ))
   (magenta    '("#a0dbea" "#a0dbea" "magenta"      ))
   (violet     '("#aabcf1" "#aabcf1" "brightmagenta"))
   (cyan       '("#6ca3c6" "#6ca3c6" "brightcyan"   ))
   (dark-cyan  '("#6892a3" "#6892a3" "cyan"   ))
