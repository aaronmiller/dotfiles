...
(def-doom-theme moonlight-wilmersdorf
  ...
  ;; name        default   256       16
  ((bg         '("#0b2f41" "#0b2f41" "black"))
   (bg-alt     '("#032634" "#032634" "black"))
   (base0      '("#002634" "#002634" "black"))
   (base1      '("#032634" "#032634" "brightblack"))
   (base2      '("#082c3a" "#082c3a" "brightblack"))
   (base3      '("#0c3040" "#0c3040" "brightblack"))
   (base4      '("#193f57" "#193f57" "brightblack"))
   (base5      '("#2e567d" "#2e567d" "brightblack"))
   (base6      '("#6c97c2" "#6c97c2" "brightblack"))
   (base7      '("#93c4f2" "#93c4f2" "brightblack"))
   (base8      '("#9ecefa" "#9ecefa" "white"))
   (indigo     '("#6494d9" "#6494d9" "brightblack"))
   (region     '("#224a66" "#224a66" "brightblack"))
   (fg         '("#b2dfff" "#b2dfff" "brightwhite"))
   (fg-alt     '("#9ecefa" "#9ecefa" "white"))

   (grey       base5)
   (red        '("#cbcdf8" "#cbcdf8" "red"          ))
   (orange     '("#90cdea" "#90cdea" "brightred"    ))
   (green      '("#45a0b5" "#45a0b5" "green"        ))
   (teal       '("#68cac7" "#68cac7" "brightgreen"  ))
   (yellow     '("#b9dba6" "#b9dba6" "yellow"       ))
   (blue       '("#6ba8e0" "#6ba8e0" "brightblue"   ))
   (light-blue '("#7ab2e5" "#7ab2e5" "yellow"       ))
   (dark-blue  '("#4b78a0" "#4b78a0" "blue"         ))
   (magenta    '("#90cdea" "#90cdea" "magenta"      ))
   (violet     '("#9aaef1" "#9aaef1" "brightmagenta"))
   (cyan       '("#5c95c6" "#5c95c6" "brightcyan"   ))
   (dark-cyan  '("#5884a3" "#5884a3" "cyan"   ))
