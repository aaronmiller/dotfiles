...
(def-doom-theme moonlight-wilmersdorf
  ...
  ;; moonlight
  ;; name        default   256       16
  ((bg         '("#0b0d41" "#0b0d41" "black"))
   (bg-alt     '("#030434" "#030434" "black"))
   (base0      '("#000434" "#000434" "black"))
   (base1      '("#030434" "#030434" "brightblack"))
   (base2      '("#080a3a" "#080a3a" "brightblack"))
   (base3      '("#0c0e40" "#0c0e40" "brightblack"))
   (base4      '("#191d57" "#191d57" "brightblack"))
   (base5      '("#2e347d" "#2e347d" "brightblack"))
   (base6      '("#6c75c2" "#6c75c2" "brightblack"))
   (base7      '("#93a2f2" "#93a2f2" "brightblack"))
   (base8      '("#9eacfa" "#9eacfa" "white"))
   (indigo     '("#6472d9" "#6472d9" "brightblack"))
   (region     '("#222866" "#222866" "brightblack"))
   (fg         '("#b2bdff" "#b2bdff" "brightwhite"))
   (fg-alt     '("#9eacfa" "#9eacfa" "white"))

   ;; wilmersdorf
   (grey       base5)
   (red        '("#cbabf8" "#cbabf8" "red"          ))
   (orange     '("#90abea" "#90abea" "brightred"    ))
   (green      '("#457eb5" "#457eb5" "green"        ))
   (teal       '("#68a8c7" "#68a8c7" "brightgreen"  ))
   (yellow     '("#b9b9a6" "#b9b9a6" "yellow"       ))
   (blue       '("#6b86e0" "#6b86e0" "brightblue"   ))
   (light-blue '("#7a90e5" "#7a90e5" "yellow"       ))
   (dark-blue  '("#4b56a0" "#4b56a0" "blue"         ))
   (magenta    '("#90abea" "#90abea" "magenta"      ))
   (violet     '("#9a8cf1" "#9a8cf1" "brightmagenta"))
   (cyan       '("#5c73c6" "#5c73c6" "brightcyan"   ))
   (dark-cyan  '("#5862a3" "#5862a3" "cyan"   ))
