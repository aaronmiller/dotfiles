...
(def-doom-theme moonlight-wilmersdorf
  ...
  ;; moonlight
  ;; name        default   256       16
  ((bg         '("#0b4541" "#0b4541" "black"))
   (bg-alt     '("#033c34" "#033c34" "black"))
   (base0      '("#003c34" "#003c34" "black"))
   (base1      '("#033c34" "#033c34" "brightblack"))
   (base2      '("#08423a" "#08423a" "brightblack"))
   (base3      '("#0c4640" "#0c4640" "brightblack"))
   (base4      '("#195557" "#195557" "brightblack"))
   (base5      '("#2e6c7d" "#2e6c7d" "brightblack"))
   (base6      '("#6cadc2" "#6cadc2" "brightblack"))
   (base7      '("#93daf2" "#93daf2" "brightblack"))
   (base8      '("#9ee4fa" "#9ee4fa" "white"))
   (indigo     '("#64aad9" "#64aad9" "brightblack"))
   (region     '("#226066" "#226066" "brightblack"))
   (fg         '("#b2f5ff" "#b2f5ff" "brightwhite"))
   (fg-alt     '("#9ee4fa" "#9ee4fa" "white"))

   ;; wilmersdorf
   (grey       base5)
   (red        '("#cbe3f8" "#cbe3f8" "red"          ))
   (orange     '("#90e3ea" "#90e3ea" "brightred"    ))
   (green      '("#45b6b5" "#45b6b5" "green"        ))
   (teal       '("#68e0c7" "#68e0c7" "brightgreen"  ))
   (yellow     '("#b9f1a6" "#b9f1a6" "yellow"       ))
   (blue       '("#6bbee0" "#6bbee0" "brightblue"   ))
   (light-blue '("#7ac8e5" "#7ac8e5" "yellow"       ))
   (dark-blue  '("#4b8ea0" "#4b8ea0" "blue"         ))
   (magenta    '("#90e3ea" "#90e3ea" "magenta"      ))
   (violet     '("#9ac4f1" "#9ac4f1" "brightmagenta"))
   (cyan       '("#5cabc6" "#5cabc6" "brightcyan"   ))
   (dark-cyan  '("#589aa3" "#589aa3" "cyan"   ))
