...
(def-doom-theme moonlight-wilmersdorf
  ...
  ;; moonlight
  ;; name        default   256       16
  ((bg         '("#0b3b41" "#0b3b41" "black"))
   (bg-alt     '("#033234" "#033234" "black"))
   (base0      '("#003234" "#003234" "black"))
   (base1      '("#033234" "#033234" "brightblack"))
   (base2      '("#08383a" "#08383a" "brightblack"))
   (base3      '("#0c3c40" "#0c3c40" "brightblack"))
   (base4      '("#194b57" "#194b57" "brightblack"))
   (base5      '("#2e627d" "#2e627d" "brightblack"))
   (base6      '("#6ca3c2" "#6ca3c2" "brightblack"))
   (base7      '("#93d0f2" "#93d0f2" "brightblack"))
   (base8      '("#9edafa" "#9edafa" "white"))
   (indigo     '("#64a0d9" "#64a0d9" "brightblack"))
   (region     '("#225666" "#225666" "brightblack"))
   (fg         '("#b2ebff" "#b2ebff" "brightwhite"))
   (fg-alt     '("#9edafa" "#9edafa" "white"))

   ;; wilmersdorf
   (grey       base5)
   (red        '("#cbd9f8" "#cbd9f8" "red"          ))
   (orange     '("#90d9ea" "#90d9ea" "brightred"    ))
   (green      '("#45acb5" "#45acb5" "green"        ))
   (teal       '("#68d6c7" "#68d6c7" "brightgreen"  ))
   (yellow     '("#b9e7a6" "#b9e7a6" "yellow"       ))
   (blue       '("#6bb4e0" "#6bb4e0" "brightblue"   ))
   (light-blue '("#7abee5" "#7abee5" "yellow"       ))
   (dark-blue  '("#4b84a0" "#4b84a0" "blue"         ))
   (magenta    '("#90d9ea" "#90d9ea" "magenta"      ))
   (violet     '("#9abaf1" "#9abaf1" "brightmagenta"))
   (cyan       '("#5ca1c6" "#5ca1c6" "brightcyan"   ))
   (dark-cyan  '("#5890a3" "#5890a3" "cyan"   ))
