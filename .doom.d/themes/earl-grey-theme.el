...
(def-doom-theme earl-grey
  ...
  (
   ;; Earl Grey Colors
   (eg-fg       '("#635d55" "#635d55" ""))
   (eg-fg2      '("#4f4a44" "#4f4a44" ""))
   (eg-bg       '("#fffefc" "#fffefc" "white"))
   (eg-bg2      '("#faf6f1" "#faf6f1" "white"))

   (eg-purple   '("#865a80" "#865a80" "magenta"))
   (eg-blue     '("#586c98" "#586c98" "brightblue"))
   (eg-teal     '("#4a7d7e" "#4a7d7e" "brightgreen"))
   (eg-orange   '("#8b6d47" "#8b6d47" "brightred"))
   (eg-green    '("#777e50" "#777e50" "green"))
   (eg-red      '("#925955" "#925955" "red"))
   (eg-berry    '("#ad538a" "#ad538a" "brightmagenta"))

   (eg-grey1    '("#efeeeb" "#efeeeb" "white"))
   (eg-grey2    '("#e0dedb" "#e0dedb" "brightblack"))
   (eg-grey3    '("#d0ceca" "#d0ceca" "brightblack"))
   (eg-grey4    '("#c1beb9" "#c1beb9" "brightblack"))
   (eg-grey5    '("#b1aea9" "#b1aea9" "brightblack"))
   (eg-grey6    '("#a19d98" "#a19d98" "brightblack"))
   (eg-grey7    '("#928d87" "#928d87" "brightblack"))
   (eg-grey8    '("#827d76" "#827d76" "brightblack"))
   (eg-grey9    '("#736d66" "#736d66" "brightblack"))

   (eg-purple1  '("#f3eef0" "#f3eef0" "brightmagenta"))
   (eg-purple2  '("#e7dde3" "#e7dde3" "brightmagenta"))
   (eg-purple3  '("#dbcdd7" "#dbcdd7" "brightmagenta"))
   (eg-purple4  '("#cfbcca" "#cfbcca" "brightmagenta"))
   (eg-purple5  '("#c3acbe" "#c3acbe" "brightmagenta"))
   (eg-purple6  '("#b69cb2" "#b69cb2" "brightmagenta"))
   (eg-purple7  '("#aa8ba5" "#aa8ba5" "brightmagenta"))
   (eg-purple8  '("#9e7b99" "#9e7b99" "magenta"))
   (eg-purple9  '("#926a8c" "#926a8c" "magenta"))

   (eg-blue1    '("#eeeff2" "#eeeff2" "brightblue"))
   (eg-blue2    '("#dee1e8" "#dee1e8" "brightblue"))
   (eg-blue3    '("#cdd2de" "#cdd2de" "brightblue"))
   (eg-blue4    '("#bcc4d4" "#bcc4d4" "brightblue"))
   (eg-blue5    '("#acb5ca" "#acb5ca" "brightblue"))
   (eg-blue6    '("#9ba6c0" "#9ba6c0" "brightblue"))
   (eg-blue7    '("#8a98b6" "#8a98b6" "brightblue"))
   (eg-blue8    '("#7989ac" "#7989ac" "blue"))
   (eg-blue9    '("#697ba2" "#697ba2" "blue"))

   (eg-teal1    '("#edf1ef" "#edf1ef" "brightgreen"))
   (eg-teal2    '("#dbe4e3" "#dbe4e3" "brightgreen"))
   (eg-teal3    '("#c9d7d6" "#c9d7d6" "brightgreen"))
   (eg-teal4    '("#b7caca" "#b7caca" "brightgreen"))
   (eg-teal5    '("#a5bebd" "#a5bebd" "brightgreen"))
   (eg-teal6    '("#92b1b0" "#92b1b0" "brightgreen"))
   (eg-teal7    '("#80a4a4" "#80a4a4" "brightgreen"))
   (eg-teal8    '("#6e9797" "#6e9797" "brightgreen"))
   (eg-teal9    '("#5c8a8b" "#5c8a8b" "brightgreen"))

   (eg-orange1  '("#f3f0ea" "#f3f0ea" "brightred"))
   (eg-orange2  '("#e8e1d8" "#e8e1d8" "brightred"))
   (eg-orange3  '("#dcd3c6" "#dcd3c6" "brightred"))
   (eg-orange4  '("#d1c4b4" "#d1c4b4" "brightred"))
   (eg-orange5  '("#c5b6a2" "#c5b6a2" "brightred"))
   (eg-orange6  '("#b9a78f" "#b9a78f" "brightred"))
   (eg-orange7  '("#ae997d" "#ae997d" "brightred"))
   (eg-orange8  '("#a28a6b" "#a28a6b" "brightred"))
   (eg-orange9  '("#977c59" "#977c59" "brightred"))

   (eg-green1   '("#f1f1eb" "#f1f1eb" "green"))
   (eg-green2   '("#e4e4da" "#e4e4da" "green"))
   (eg-green3   '("#d6d8c8" "#d6d8c8" "green"))
   (eg-green4   '("#c9cbb7" "#c9cbb7" "green"))
   (eg-green5   '("#bbbea6" "#bbbea6" "green"))
   (eg-green6   '("#adb195" "#adb195" "green"))
   (eg-green7   '("#a0a484" "#a0a484" "green"))
   (eg-green8   '("#929872" "#929872" "green"))
   (eg-green9   '("#858b61" "#858b61" "green"))

   (eg-red1     '("#f4eeeb" "#f4eeeb" "brightred"))
   (eg-red2     '("#e9dddb" "#e9dddb" "brightred"))
   (eg-red3     '("#decdca" "#decdca" "brightred"))
   (eg-red4     '("#d3bcb9" "#d3bcb9" "brightred"))
   (eg-red5     '("#c9aca9" "#c9aca9" "brightred"))
   (eg-red6     '("#be9b98" "#be9b98" "brightred"))
   (eg-red7     '("#b38b87" "#b38b87" "brightred"))
   (eg-red8     '("#a87a76" "#a87a76" "red"))
   (eg-red9     '("#9d6a66" "#9d6a66" "red"))

   (eg-berry1     '("#f7edf1" "#f7edf1" "brightmagenta"))
   (eg-berry2     '("#efdce5" "#efdce5" "brightmagenta"))
   (eg-berry3     '("#e6cbda" "#e6cbda" "brightmagenta"))
   (eg-berry4     '("#debace" "#debace" "brightmagenta"))
   (eg-berry5     '("#d6a9c3" "#d6a9c3" "brightmagenta"))
   (eg-berry6     '("#ce97b8" "#ce97b8" "brightmagenta"))
   (eg-berry7     '("#c686ac" "#c686ac" "brightmagenta"))
   (eg-berry8     '("#bd75a1" "#bd75a1" "brightmagenta"))
   (eg-berry9     '("#b56495" "#b56495" "brightmagenta"))
