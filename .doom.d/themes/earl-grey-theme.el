...
(def-doom-theme earl-grey
  ...
  (
   ;; Earl Grey Colors
   (eg-fg       '("#605A52" "#605A52" ""))
   (eg-fg2      '("#4C4741" "#4C4741" ""))
   (eg-bg       '("#FCFBF9" "#FCFBF9" "white"))
   (eg-bg2      '("#F7F3EE" "#F7F3EE" "white"))

   (eg-purple   '("#83577D" "#83577D" "magenta"))
   (eg-blue     '("#556995" "#556995" "brightblue"))
   (eg-teal     '("#477A7B" "#477A7B" "brightgreen"))
   (eg-orange   '("#886A44" "#886A44" "brightred"))
   (eg-green    '("#747B4D" "#747B4D" "green"))
   (eg-red      '("#8F5652" "#8F5652" "red"))
   (eg-berry    '("#AA5087" "#AA5087" "brightmagenta"))

   (eg-grey1    '("#ECEBE8" "#ECEBE8" "white"))
   (eg-grey2    '("#DDDBD8" "#DDDBD8" "brightblack"))
   (eg-grey3    '("#CDCBC7" "#CDCBC7" "brightblack"))
   (eg-grey4    '("#BEBBB6" "#BEBBB6" "brightblack"))
   (eg-grey5    '("#AEABA6" "#AEABA6" "brightblack"))
   (eg-grey6    '("#9E9A95" "#9E9A95" "brightblack"))
   (eg-grey7    '("#8F8A84" "#8F8A84" "brightblack"))
   (eg-grey8    '("#7F7A73" "#7F7A73" "brightblack"))
   (eg-grey9    '("#706A63" "#706A63" "brightblack"))

   (eg-purple1  '("#F0EBED" "#F0EBED" "brightmagenta"))
   (eg-purple2  '("#E4DAE0" "#E4DAE0" "brightmagenta"))
   (eg-purple3  '("#D8CAD4" "#D8CAD4" "brightmagenta"))
   (eg-purple4  '("#CCB9C7" "#CCB9C7" "brightmagenta"))
   (eg-purple5  '("#C0A9BB" "#C0A9BB" "brightmagenta"))
   (eg-purple6  '("#B399AF" "#B399AF" "brightmagenta"))
   (eg-purple7  '("#A788A2" "#A788A2" "brightmagenta"))
   (eg-purple8  '("#9B7896" "#9B7896" "magenta"))
   (eg-purple9  '("#8F6789" "#8F6789" "magenta"))

   (eg-blue1    '("#EBECEF" "#EBECEF" "brightblue"))
   (eg-blue2    '("#DBDEE5" "#DBDEE5" "brightblue"))
   (eg-blue3    '("#CACFDB" "#CACFDB" "brightblue"))
   (eg-blue4    '("#B9C1D1" "#B9C1D1" "brightblue"))
   (eg-blue5    '("#A9B2C7" "#A9B2C7" "brightblue"))
   (eg-blue6    '("#98A3BD" "#98A3BD" "brightblue"))
   (eg-blue7    '("#8795B3" "#8795B3" "brightblue"))
   (eg-blue8    '("#7686A9" "#7686A9" "blue"))
   (eg-blue9    '("#66789F" "#66789F" "blue"))

   (eg-teal1    '("#EAEEEC" "#EAEEEC" "brightgreen"))
   (eg-teal2    '("#D8E1E0" "#D8E1E0" "brightgreen"))
   (eg-teal3    '("#C6D4D3" "#C6D4D3" "brightgreen"))
   (eg-teal4    '("#B4C7C7" "#B4C7C7" "brightgreen"))
   (eg-teal5    '("#A2BBBA" "#A2BBBA" "brightgreen"))
   (eg-teal6    '("#8FAEAD" "#8FAEAD" "brightgreen"))
   (eg-teal7    '("#7DA1A1" "#7DA1A1" "brightgreen"))
   (eg-teal8    '("#6B9494" "#6B9494" "brightgreen"))
   (eg-teal9    '("#598788" "#598788" "brightgreen"))

   (eg-orange1  '("#F0EDE7" "#F0EDE7" "brightred"))
   (eg-orange2  '("#E5DED5" "#E5DED5" "brightred"))
   (eg-orange3  '("#D9D0C3" "#D9D0C3" "brightred"))
   (eg-orange4  '("#CEC1B1" "#CEC1B1" "brightred"))
   (eg-orange5  '("#C2B39F" "#C2B39F" "brightred"))
   (eg-orange6  '("#B6A48C" "#B6A48C" "brightred"))
   (eg-orange7  '("#AB967A" "#AB967A" "brightred"))
   (eg-orange8  '("#9F8768" "#9F8768" "brightred"))
   (eg-orange9  '("#947956" "#947956" "brightred"))

   (eg-green1   '("#EEEEE8" "#EEEEE8" "green"))
   (eg-green2   '("#E1E1D7" "#E1E1D7" "green"))
   (eg-green3   '("#D3D5C5" "#D3D5C5" "green"))
   (eg-green4   '("#C6C8B4" "#C6C8B4" "green"))
   (eg-green5   '("#B8BBA3" "#B8BBA3" "green"))
   (eg-green6   '("#AAAE92" "#AAAE92" "green"))
   (eg-green7   '("#9DA181" "#9DA181" "green"))
   (eg-green8   '("#8F956F" "#8F956F" "green"))
   (eg-green9   '("#82885E" "#82885E" "green"))

   (eg-red1     '("#F1EBE8" "#F1EBE8" "brightred"))
   (eg-red2     '("#E6DAD8" "#E6DAD8" "brightred"))
   (eg-red3     '("#DBCAC7" "#DBCAC7" "brightred"))
   (eg-red4     '("#D0B9B6" "#D0B9B6" "brightred"))
   (eg-red5     '("#C6A9A6" "#C6A9A6" "brightred"))
   (eg-red6     '("#BB9895" "#BB9895" "brightred"))
   (eg-red7     '("#B08884" "#B08884" "brightred"))
   (eg-red8     '("#A57773" "#A57773" "red"))
   (eg-red9     '("#9A6763" "#9A6763" "red"))

   (eg-berry1     '("#F4EAEE" "#F4EAEE" "brightmagenta"))
   (eg-berry2     '("#ECD9E2" "#ECD9E2" "brightmagenta"))
   (eg-berry3     '("#E3C8D7" "#E3C8D7" "brightmagenta"))
   (eg-berry4     '("#DBB7CB" "#DBB7CB" "brightmagenta"))
   (eg-berry5     '("#D3A6C0" "#D3A6C0" "brightmagenta"))
   (eg-berry6     '("#CB94B5" "#CB94B5" "brightmagenta"))
   (eg-berry7     '("#C383A9" "#C383A9" "brightmagenta"))
   (eg-berry8     '("#BA729E" "#BA729E" "brightmagenta"))
   (eg-berry9     '("#B26192" "#B26192" "brightmagenta"))
