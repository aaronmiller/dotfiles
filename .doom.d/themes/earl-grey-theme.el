...
(def-doom-theme earl-grey
  ...
  (
   ;; Earl Grey Colors
   (eg-fg       '("#635e55" "#635e55" ""))
   (eg-fg2      '("#4f4b44" "#4f4b44" ""))
   (eg-bg       '("#fffffc" "#fffffc" "white"))
   (eg-bg2      '("#faf7f1" "#faf7f1" "white"))

   (eg-purple   '("#865b80" "#865b80" "magenta"))
   (eg-blue     '("#586d98" "#586d98" "brightblue"))
   (eg-teal     '("#4a7e7e" "#4a7e7e" "brightgreen"))
   (eg-orange   '("#8b6e47" "#8b6e47" "brightred"))
   (eg-green    '("#777f50" "#777f50" "green"))
   (eg-red      '("#925a55" "#925a55" "red"))
   (eg-berry    '("#ad548a" "#ad548a" "brightmagenta"))

   (eg-grey1    '("#efefeb" "#efefeb" "white"))
   (eg-grey2    '("#e0dfdb" "#e0dfdb" "brightblack"))
   (eg-grey3    '("#d0cfca" "#d0cfca" "brightblack"))
   (eg-grey4    '("#c1bfb9" "#c1bfb9" "brightblack"))
   (eg-grey5    '("#b1afa9" "#b1afa9" "brightblack"))
   (eg-grey6    '("#a19e98" "#a19e98" "brightblack"))
   (eg-grey7    '("#928e87" "#928e87" "brightblack"))
   (eg-grey8    '("#827e76" "#827e76" "brightblack"))
   (eg-grey9    '("#736e66" "#736e66" "brightblack"))

   (eg-purple1  '("#f3eff0" "#f3eff0" "brightmagenta"))
   (eg-purple2  '("#e7dee3" "#e7dee3" "brightmagenta"))
   (eg-purple3  '("#dbced7" "#dbced7" "brightmagenta"))
   (eg-purple4  '("#cfbdca" "#cfbdca" "brightmagenta"))
   (eg-purple5  '("#c3adbe" "#c3adbe" "brightmagenta"))
   (eg-purple6  '("#b69db2" "#b69db2" "brightmagenta"))
   (eg-purple7  '("#aa8ca5" "#aa8ca5" "brightmagenta"))
   (eg-purple8  '("#9e7c99" "#9e7c99" "magenta"))
   (eg-purple9  '("#926b8c" "#926b8c" "magenta"))

   (eg-blue1    '("#eef0f2" "#eef0f2" "brightblue"))
   (eg-blue2    '("#dee2e8" "#dee2e8" "brightblue"))
   (eg-blue3    '("#cdd3de" "#cdd3de" "brightblue"))
   (eg-blue4    '("#bcc5d4" "#bcc5d4" "brightblue"))
   (eg-blue5    '("#acb6ca" "#acb6ca" "brightblue"))
   (eg-blue6    '("#9ba7c0" "#9ba7c0" "brightblue"))
   (eg-blue7    '("#8a99b6" "#8a99b6" "brightblue"))
   (eg-blue8    '("#798aac" "#798aac" "blue"))
   (eg-blue9    '("#697ca2" "#697ca2" "blue"))

   (eg-teal1    '("#edf2ef" "#edf2ef" "brightgreen"))
   (eg-teal2    '("#dbe5e3" "#dbe5e3" "brightgreen"))
   (eg-teal3    '("#c9d8d6" "#c9d8d6" "brightgreen"))
   (eg-teal4    '("#b7cbca" "#b7cbca" "brightgreen"))
   (eg-teal5    '("#a5bfbd" "#a5bfbd" "brightgreen"))
   (eg-teal6    '("#92b2b0" "#92b2b0" "brightgreen"))
   (eg-teal7    '("#80a5a4" "#80a5a4" "brightgreen"))
   (eg-teal8    '("#6e9897" "#6e9897" "brightgreen"))
   (eg-teal9    '("#5c8b8b" "#5c8b8b" "brightgreen"))

   (eg-orange1  '("#f3f1ea" "#f3f1ea" "brightred"))
   (eg-orange2  '("#e8e2d8" "#e8e2d8" "brightred"))
   (eg-orange3  '("#dcd4c6" "#dcd4c6" "brightred"))
   (eg-orange4  '("#d1c5b4" "#d1c5b4" "brightred"))
   (eg-orange5  '("#c5b7a2" "#c5b7a2" "brightred"))
   (eg-orange6  '("#b9a88f" "#b9a88f" "brightred"))
   (eg-orange7  '("#ae9a7d" "#ae9a7d" "brightred"))
   (eg-orange8  '("#a28b6b" "#a28b6b" "brightred"))
   (eg-orange9  '("#977d59" "#977d59" "brightred"))

   (eg-green1   '("#f1f2eb" "#f1f2eb" "green"))
   (eg-green2   '("#e4e5da" "#e4e5da" "green"))
   (eg-green3   '("#d6d9c8" "#d6d9c8" "green"))
   (eg-green4   '("#c9ccb7" "#c9ccb7" "green"))
   (eg-green5   '("#bbbfa6" "#bbbfa6" "green"))
   (eg-green6   '("#adb295" "#adb295" "green"))
   (eg-green7   '("#a0a584" "#a0a584" "green"))
   (eg-green8   '("#929972" "#929972" "green"))
   (eg-green9   '("#858c61" "#858c61" "green"))

   (eg-red1     '("#f4efeb" "#f4efeb" "brightred"))
   (eg-red2     '("#e9dedb" "#e9dedb" "brightred"))
   (eg-red3     '("#dececa" "#dececa" "brightred"))
   (eg-red4     '("#d3bdb9" "#d3bdb9" "brightred"))
   (eg-red5     '("#c9ada9" "#c9ada9" "brightred"))
   (eg-red6     '("#be9c98" "#be9c98" "brightred"))
   (eg-red7     '("#b38c87" "#b38c87" "brightred"))
   (eg-red8     '("#a87b76" "#a87b76" "red"))
   (eg-red9     '("#9d6b66" "#9d6b66" "red"))

   (eg-berry1     '("#f7eef1" "#f7eef1" "brightmagenta"))
   (eg-berry2     '("#efdde5" "#efdde5" "brightmagenta"))
   (eg-berry3     '("#e6ccda" "#e6ccda" "brightmagenta"))
   (eg-berry4     '("#debbce" "#debbce" "brightmagenta"))
   (eg-berry5     '("#d6aac3" "#d6aac3" "brightmagenta"))
   (eg-berry6     '("#ce98b8" "#ce98b8" "brightmagenta"))
   (eg-berry7     '("#c687ac" "#c687ac" "brightmagenta"))
   (eg-berry8     '("#bd76a1" "#bd76a1" "brightmagenta"))
   (eg-berry9     '("#b56595" "#b56595" "brightmagenta"))
