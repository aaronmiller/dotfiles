...
(def-doom-theme wilmersdorf-palenight
  "A dark theme inspired by Ian Pan's Wilmersdorf"

  ;; name        default   256       16
  ((bg         '("#292D3E" "#292D3E" nil            ))
   (bg-alt     '("#242837" "#242837" nil            ))
   (base0      '("#232635" "#232635" "black"        ))
   (base1      '("#282b33" "#282b33" "brightblack"  ))
   (base2      '("#232635" "#232635" "brightblack"  ))
   (base3      '("#3C435E" "#3C435E" "brightblack"  ))
   ...
   (base8      '("#c0c5ce" "#c0c5ce" "white"        ))
   (fg-alt     '("#c0c5ce" "#c0c5ce" "brightwhite"  ))
   (fg         '("#c0c5ce" "#c0c5ce" "white"        ))

   (grey       base4)
   (red        '("#e06383" "#e06383" "red"          ))
   (orange     '("#a6c1e0" "#a6c1e0" "brightred"    ))
   (green      '("#5b94ab" "#5b94ab" "green"        ))
   (teal       '("#7ebebd" "#7ebebd" "brightgreen"  ))
   (yellow     '("#cfcf9c" "#cfcf9c" "yellow"       ))
   (blue       '("#a6c1e0" "#a6c1e0" "brightblue"   ))
